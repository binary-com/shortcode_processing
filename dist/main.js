...
var get_bet_parameters = exports.get_bet_parameters = function get_bet_parameters(shortcode, currency, is_sold, active_symbols) {
    var parameters = {
        bet_type: 'Invalid',
        underlying: 'config',
        currency: currency
    ...
    var match = shortcode.match(/^([^_]+)_([\w\d^_]+)_(\d*\.?\d*)_(\d+F?)_(\d+[FT]?)_S?(-?\d+)P?_S?(-?\d+)P?/);
    if (!match) {
        ...
        if (match) {
            var underlying = (0, _utils.find)(active_symbols, function (underlying) {
                return underlying.symbol === match[2];
            });
            parameters = {
                barrier_count: 0,
                shortcode: match[0],
        ...
        if (+match[6] === 0) {
            ...
            parameters.barrier = +match[6] * _underlying.pip;
            parameters.barrier_count = 1;
        } else {
            // Two barriers available
            parameters.high_barrier = +match[6] * _underlying.pip;
            parameters.low_barrier = +match[7] * _underlying.pip;
...
var _translation = __webpack_require__(119);
...
var contract_map = {
    ...
    CALL: function CALL(param) {
        if (param.barrier_count === 0) {
            ...
            if (param.barrier > 0) param.entry_spot = 'entry spot plus ' + Math.abs(param.barrier);else param.entry_spot = 'entry spot minus ' + Math.abs(param.barrier);
        }
        ...
        if (param.fixed_expiry === 1) {
            if (is_daily(param.date_expiry - param.date_start)) //Daily
                param.date_expiry = 'close on ' + get_date(param.date_expiry);else //Intraday
...
var get_duration = function get_duration(diff) {
    var duration = _moment2.default.duration(diff * 1000);
    var duration_str = '';
    if (duration.days()) duration_str += t.translate('[n] day', '[n] days', { n: duration.days() });
    if (duration.hours()) duration_str += duration_str ? ' ' + t.translate('[n] hour', '[n] hours', { n: duration.hours() }) : t.translate('[n] hour', '[n] hours', { n: duration.hours() });
    if (duration.minutes()) duration_str += duration_str ? ' ' + t.translate('[n] minute', '[n] minutes', { n: duration.minutes() }) : t.translate('[n] minute', '[n] minutes', { n: duration.minutes() });
    if (duration.seconds()) duration_str += duration_str ? ' ' + t.translate('[n] second', '[n] seconds', { n: duration.seconds() }) : t.translate('[n] second', '[n] seconds', { n: duration.seconds() });

    return duration_str;
};

var get_date_time = function get_date_time(ts) {
    return _moment2.default.utc(ts * 1000).format('YYYY-MM-DD HH:mm:ss') + ' GMT';
};
var get_date = function get_date(ts) {
    return _moment2.default.utc(ts * 1000).format('YYYY-MM-DD');
};

var is_daily = function is_daily(diff) {
    return _moment2.default.duration(diff * 1000).days() > 0;
};

var longcode = exports.longcode = function longcode(bet_param, lang) {
    t = new _translation.Translation(lang);
...
exports.ShortcodeProcessing = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _get_bet_parameters = __webpack_require__(116);

var _longcode_generator = __webpack_require__(117);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ShortcodeProcessing = exports.ShortcodeProcessing = function () {
    function ShortcodeProcessing(active_symbols, lang) {
        _classCallCheck(this, ShortcodeProcessing);

        this.active_symbols = active_symbols;
        this.lang = lang || 'en'; // EN is fallback language.
    }

    _createClass(ShortcodeProcessing, [{
        ...
        value: function getBetParameters(shortcode) {
            return (0, _get_bet_parameters.get_bet_parameters)(shortcode);
        }
    }]);

    return ShortcodeProcessing;
}();
...
var _de = __webpack_require__(121);

var _de2 = _interopRequireDefault(_de);

var _en = __webpack_require__(122);

var _en2 = _interopRequireDefault(_en);

var _es = __webpack_require__(123);

var _es2 = _interopRequireDefault(_es);

var _fr = __webpack_require__(124);

var _fr2 = _interopRequireDefault(_fr);

var _id = __webpack_require__(125);

var _id2 = _interopRequireDefault(_id);

var _it = __webpack_require__(126);

var _it2 = _interopRequireDefault(_it);

var _ja = __webpack_require__(127);

var _ja2 = _interopRequireDefault(_ja);

var _pl = __webpack_require__(128);

var _pl2 = _interopRequireDefault(_pl);

var _pt = __webpack_require__(129);

var _pt2 = _interopRequireDefault(_pt);

var _ru = __webpack_require__(130);

var _ru2 = _interopRequireDefault(_ru);

var _th = __webpack_require__(132);

var _th2 = _interopRequireDefault(_th);

var _vi = __webpack_require__(133);

var _vi2 = _interopRequireDefault(_vi);

var _zh_cn = __webpack_require__(134);

var _zh_cn2 = _interopRequireDefault(_zh_cn);

var _zh_tw = __webpack_require__(135);
